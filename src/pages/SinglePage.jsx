...
export default function SinglePage() {
  ...
  return (
    <div className="text-white grid grid-cols-3 py-6">
      {isLoading ? (
        ...
        <>
          {error ? (
            <div className="col-span-3 flex items-center flex-col justify-center min-h-[70vh]">
            ...
            <>
              <motion.div
                ...
                className="text-5xl text-secondary font-bold col-span-1 px-6"
              >
                <SingleCoinInfo data={data} />
              </motion.div>
              <div className="text-5xl text-secondary font-bold col-span-2 border-l-[2px] border-l-[#808080]">
